...
void EaseBack::setOvershoot(NUMBER overshoot_)
{
...
NUMBER EaseBack::easeIn(NUMBER time_) const
{
  time_ /= _duration;
...
NUMBER EaseBack::easeOut(NUMBER time_) const
{
...
NUMBER EaseBack::easeInOut(NUMBER time_) const
{
  NUMBER overshoot;
