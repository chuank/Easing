...
NUMBER EaseCircular::easeIn(NUMBER time_) const
{
  time_ /= _duration;
...
NUMBER EaseCircular::easeOut(NUMBER time_) const
{
...
NUMBER EaseCircular::easeInOut(NUMBER time_) const
{
  time_ /= _duration / 2;
